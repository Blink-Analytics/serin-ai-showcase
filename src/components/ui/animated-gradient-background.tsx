...
interface AnimatedGradientBackgroundProps {
    ...
    * @default ["#000000", "#0F172A", "#1E3A8A", "#3B82F6", "#6366F1", "#8B5CF6", "#A855F7"]
    */
 ...
 * 
 * Customized with dark theme: black background, dark blue primary, electric blue accents, and purple highlights.
 *
